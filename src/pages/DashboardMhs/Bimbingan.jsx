...
const Bimbingan = () => {
    return (
        <div className='p-4 md:w-[60%] lg:w-[68%] lg:p-8'>
            <div className='border border-slate-300 rounded-md px-4 py-2 min-h-96'>
                ...
                {/* Form Section */}
                <div className='mt-20 grid grid-cols-1 gap-4 xl:grid-cols-4'>
                    {link.map(item => (
                        <a href={item.link}>
                            <div className='w-56 h-32 rounded-lg border-2 border-slate-300 hover:border-black hover:text-black text-slate-600  p-2 flex justify-center items-center' key={item.id}>
