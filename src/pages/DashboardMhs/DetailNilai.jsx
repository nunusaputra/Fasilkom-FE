...
const Detaildata = () => {
    ...
    useEffect(() => {
        ...
        } else if (data.total > 85 && data.total <= 89) {
            setStatus("Nilai A-")
            setColor("bg-green-500")
        } else if (data.total > 80 && data.total <= 85) {
            setStatus("Nilai B+")
            setColor("bg-blue-500")
        } else if (data.total > 75 && data.total <= 79) {
            setStatus("Nilai B")
            setColor("bg-blue-500")
        } else if (data.total > 70 && data.total <= 74) {
            setStatus("Nilai B-")
            setColor("bg-blue-500")
        } else if (data.total > 65 && data.total <= 69) {
            setStatus("Nilai C+")
            setColor("bg-yellow-500")
        } else if (data.total > 60 && data.total <= 64) {
            setStatus("Nilai C")
            setColor("bg-yellow-500")
        } else if (data.total > 55 && data.total <= 59) {
            setStatus("Nilai C-")
            setColor("bg-yellow-500")
        } else if (data.total > 50 && data.total <= 54) {
            setStatus("Nilai D")
