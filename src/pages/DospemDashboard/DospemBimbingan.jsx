...
const DospemBimbingan = () => {
    ...
    const currentPost = Array.isArray(bimbingan) ? bimbingan.slice(firstPostIndex, lastPostIndex) : []
                ...
                <div className='mt-3'>
                                ...
                                currentPost.length > 0 ? (
                                    ...
                                    <tr className=''>
                                        <td colSpan={50} className='text-center' style={{ height: '100px', verticalAlign: 'middle' }}>
                                            <div style={{ display: 'flex', justifyContent: 'center', alignItems: 'center', height: '100%' }}>
                                                <DataNotFound>
                                                    Tidak ada daftar mahasiswa bimbingan
                                                </DataNotFound>
                                            </div>
                                        </td>
                                    </tr>
                    ...
                    {!isLoading && (
                        <Pagination
                            ...
                            totalPost={bimbingan && bimbingan.length}
