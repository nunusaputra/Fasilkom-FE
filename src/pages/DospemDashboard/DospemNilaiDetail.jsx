...
const DospemNilaiDetail = () => {
    ...
    useEffect(() => {
        ...
        } else if (nilai.total > 85 && nilai.total <= 89) {
            setStatus("Nilai A-")
            setColor("bg-green-500")
        } else if (nilai.total > 80 && nilai.total <= 85) {
            setStatus("Nilai B+")
            setColor("bg-blue-500")
        } else if (nilai.total > 75 && nilai.total <= 79) {
            setStatus("Nilai B")
            setColor("bg-blue-500")
        } else if (nilai.total > 70 && nilai.total <= 74) {
            setStatus("Nilai B-")
            setColor("bg-blue-500")
        } else if (nilai.total > 65 && nilai.total <= 69) {
            setStatus("Nilai C+")
            setColor("bg-yellow-500")
        } else if (nilai.total > 60 && nilai.total <= 64) {
            setStatus("Nilai C")
            setColor("bg-yellow-500")
        } else if (nilai.total > 55 && nilai.total <= 59) {
            setStatus("Nilai C-")
            setColor("bg-yellow-500")
        } else if (nilai.total > 50 && nilai.total <= 54) {
            setStatus("Nilai D")
