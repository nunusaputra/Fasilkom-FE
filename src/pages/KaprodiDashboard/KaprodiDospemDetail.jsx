...
import { getDospemById, updateDospem } from '../../redux/Action/DospemAction'
                    ...
                    <div className='flex flex-col gap-4 mt-10'>
                        <div className='flex gap-2 lg:gap-4'>
                            ...
                            <div className='flex flex-col gap-2 self-center'>
                                <h1 className='text-lg font-semibold lg:text-xl'>{dospem.nama}</h1>
                        ...
                        <div className="mt-6 ">
                            <dl className="divide-y divide-gray-900">
                                ...
                                <div className="px-4 py-3 sm:py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-0">
                                    ...
                                    <dd className="mt-1 text-sm leading-6 text-gray-700 sm:col-span-2 sm:mt-0">
                                        {dospem.dospemId !== null ? (
                                            <p className='text-sm leading-6 text-gray-700 sm:col-span-2 sm:mt-0 '>{dospem.User.name}</p>
                                        ) : (
                                            <form onSubmit={handleSubmit}>
                                                <div>
                                                    <label htmlFor="dosen" className='block text-sm font-bold text-slate-600 mb-2'>Program Studi</label>
                                                    <select name="dosen" id="dosen" value={dosen} onChange={(e) => setDosen(e.target.value)} className='text-sm border border-primary rounded w-full py-2 px-3 text-slate-700 focus:outline-none focus:ring-1 focus:ring-primary focus:border-transparent'>
