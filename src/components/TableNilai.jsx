        ...
        <table className='table'>
            ...
            <tbody>
                <tr className='bg-slate-300 text-lg font-bold'>
                    ...
                    <td>{nilai.disiplin + nilai.sikap + nilai.tanggung_jawab + nilai.kehadiran + nilai.tata_tertib + nilai.penampilan}</td>
                </tr>
                <tr>
                    <td>1</td>
                ...
                <tr className='bg-slate-300 text-lg font-bold'>
                    ...
                    <td>{nilai.kemampuan_kerja + nilai.keterampilan_kerja + nilai.kualitas_kerja}</td>
                </tr>
                <tr>
                    <td>7</td>
                ...
                <tr className='bg-slate-300 text-lg font-bold'>
                    ...
                    <td>{nilai.relevansi + nilai.isi_laporan}</td>
                </tr>
                <tr>
                    <td>14</td>
